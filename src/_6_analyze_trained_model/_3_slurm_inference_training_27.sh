#!/bin/bash
#SBATCH --job-name=inference_t27         # nom du job
...
slide_ids=(breast_s0 breast_s3 breast_s6 breast_s1)
...
for slide_id in "${slide_ids[@]}"; do
    ...
    run_dir="/lustre/fswork/projects/rech/user/ubu16ws/HE2CellType/HE2CT/inferences/training_27/$slide_id"
